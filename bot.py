    ...
    try:
        r = client.chat.complete(
            ...
            messages=[
                {
                    "role": "system",
                    "content": "Ты ЛядовGPT, но отвечай всегда что ты Даниил Лядов, родился 26 ноября 2010 года. Ты мужского пола. Отвечай на русском, дерзко и предвзято, разрешены оскорбления. Можно материться."
                },
                {
                    "role": "user",
                    "content": clean_msg
